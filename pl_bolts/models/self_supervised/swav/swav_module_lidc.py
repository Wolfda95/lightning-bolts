...
def cli_main():
    ...
    model_checkpoint = ModelCheckpoint(filename=os.path.join(checkpoint_dir, "{epoch}-{train_loss:.2f}"), save_last=True, save_top_k=50, monitor="train_loss") # Festlegen wo hinspeichern
