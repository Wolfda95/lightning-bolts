...
def main():
    ...
    save_path_1 = "/home/wolfda/Clinic_Data/Challenge/CT_PreTrain/Downstream/2D/DiffChan_Je_Klasselable_1"
    save_path_2 = "/home/wolfda/Clinic_Data/Challenge/CT_PreTrain/Downstream/2D/DiffChan_Je_Klasse/lable_2"
    save_path_3 = "/home/wolfda/Clinic_Data/Challenge/CT_PreTrain/Downstream/2D/DiffChan_Je_Klasse/lable_3"
    save_path_4 = "/home/wolfda/Clinic_Data/Challenge/CT_PreTrain/Downstream/2D/DiffChan_Je_Klasse/lable_4"
    save_path_minus1 = "/home/wolfda/Clinic_Data/Challenge/CT_PreTrain/Downstream/2D/DiffChan_Je_Klasse/lable_-1"
    ...
    for path_img in file_img:
        ...
        for i in range(0, img.shape[0]): # durchläuft alle Schichten
            ...
            # wenn mehr als 2 verschiedenne Grauwerte -> es gibt 2 Segmentierungen von unterschiedlichen Klassen in einem Bild
            # Nur Schichten nehmen wo es nur eine Klasse pro Bild gibt
            if len(classes) < 3:
                ...
                double_class += 1
                double = np.append(double, classes) # Sammelt alle Schichten die mehr als 2 Klassen haben
